        ...
        return (
            <HashRouter>
                ...
                <footer className="bg-light text-dark my-3 mx-5 p-2 border rounded-sm text-center">
                    ...
                    <a href="https://github.com/killeand/CRUDGenerator">CRUD Generator</a> by Jason Johnston is licensed under <a href="http://creativecommons.org/licenses/by/4.0/?ref=chooser-v1" target="_blank" style={{"display":"inline-block"}}>CC BY 4.0<img style={{"height":"22px","margin-left":"3px","vertical-align":"text-bottom"}} src="https://mirrors.creativecommons.org/presskit/icons/cc.svg?ref=chooser-v1" /><img style={{"height":"22px","margin-left":"3px","vertical-align":"text-bottom"}} src="https://mirrors.creativecommons.org/presskit/icons/by.svg?ref=chooser-v1" /></a>
                </footer>
            </HashRouter>
        );
    }
